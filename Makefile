...
cudnn:
	/home/kyan2/llvm-15.x-install/bin/clang++ -I/usr/include/opencv4 -I/usr/local/cuda/include -DOPENCV -std=c++11 -Wall -Wno-unused-result -Wno-unknown-pragmas -Wfatal-errors -fPIC -fopenmp -g -O0 -Ofast -lm -lopencv_core -lopencv_imgproc -lopencv_highgui -lopencv_imgcodecs -lcudart -lcublas -lcudnn -L/home/kyan2/llvm-15.x-install/lib -L/usr/local/cuda/lib -L/usr/local/cuda/lib64 main-multi-gpu.cpp helpers_main_evals.cpp conv-cudnn.cpp connect-cudnn.cpp util.cpp -o main-cudnn
